...
class AgentState(TypedDict):
    ...
    compile_retry_count: int    # Tracks consecutive validation failures
    ...
    active_story_ids: List[str] # List of IDs of the stories currently being worked on in parallel
